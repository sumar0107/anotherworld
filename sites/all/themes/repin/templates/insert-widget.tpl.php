...
<?php endif; ?>
  <table class="insert-template">
    <tr>
      <td><input type="submit" rel="<?php print $widget_type ?>" class="form-submit insert-button" onclick="return false;" value="Влево" float="left" /></td>
      <td><input type="submit" rel="<?php print $widget_type ?>" class="form-submit insert-button" onclick="return false;" value="Вправо" float="right" /></td>
    </tr>
  </table>
<?php if (count($insert_styles) > 1): ?>
  </div>

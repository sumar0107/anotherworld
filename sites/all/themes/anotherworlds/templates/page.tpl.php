	...
	<div id="pre_header">
		<header class="header" id="header" role="banner">
		  <?php if ($logo): ?>
			...
			<?php /* <a href="/why-repin" id="repin">А почему Repin?</a>*/?>
		  <?php endif; ?>
	  ...
	  <?php /*print render($content['field_img']); */?>
			...
			<?php if (drupal_is_front_page()) { ?>
			  <div id="front-top" class="clearfix">
				<?php
				$block1 = block_load('views', 'slideshow-block' );
				$block2 = _block_get_renderable_array(_block_render_blocks(array($block1)));
				print drupal_render($block2);

...
<article class="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
	...
	<?php if ((isset($node->field_category) && !empty($node->field_category['und'])) || $node->type == 'picture_day' || $node->type == 'video_day'): ?>
		...
		<span class="create-ico com" title="Количество коментариев">
			...
			<span class="create-ico" title="Тэги"><span
					class="pr"></span><?php print render($content['field_tags']); ?><?php print render($content['field_field_autohs']); ?></span>
		</div>
	<?php endif; ?>
	<div class="clear"></div>
		...
		<div class="rating">
			...
			<div class="share">
				...
				<div class="yashare-auto-init" data-yashareL10n="ru" data-yashareType="button"
					 data-yashareQuickServices="vkontakte,facebook,twitter,odnoklassniki"></div>
			</div>
		</div>
	<?php } ?>

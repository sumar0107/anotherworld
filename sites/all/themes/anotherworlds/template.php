...
function anotherworlds_preprocess_page(&$variables, $hook)
{
	...
	if (drupal_is_front_page()) {
		...
		$slideshow = block_load('views', 'slideshow-block');
		$slideshow = _block_get_renderable_array(_block_render_blocks(array($slideshow)));
		$variables['slideshow'] = drupal_render($slideshow);
	}
